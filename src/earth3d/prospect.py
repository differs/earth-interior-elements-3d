...
RULES = {
    ...
    # --- v0.3l 第四批扩展族(PP1802 技术/工业/肥料) ---
    "Ga":      (1.8, 0.2, 0.2, "镓多为铝土矿/闪锌矿副产, 锚点为主"),
    "Ge":      (1.8, 0.2, 0.2, "锗在闪锌矿/煤/硫化物, 锚点为主"),
    "In":      (1.8, 0.2, 0.3, "铟为闪锌矿副产, 锚点为主"),
    "Tl":      (1.8, 0.2, 0.2, "铊在硫化物热液矿床, 锚点为主"),
    "Se":      (1.7, 0.3, 0.2, "硒在铜硫化物/火山硫, 锚点为主"),
    "Te":      (1.8, 0.2, 0.2, "碲在热液 Au/硫化物, 锚点为主"),
    "Hf":      (1.6, 0.4, 0.4, "铪随锆(砂矿/碱性杂岩)"),
    "Sr":      (1.6, 0.3, 0.4, "天青石, 蒸发/沉积盆地"),
    "Ba":      (1.6, 0.4, 0.3, "重晶石脉/层控, 常近裂谷或热液"),
    "F":       (1.7, 0.5, 0.3, "萤石与花岗岩-热液脉有关"),
    "K":       (1.8, 0.2, 0.3, "钾盐为蒸发盐盆地沉积"),
    "P":       (1.7, 0.3, 0.3, "磷块岩沉积/岩浆磷灰石, 锚点为主"),
}
